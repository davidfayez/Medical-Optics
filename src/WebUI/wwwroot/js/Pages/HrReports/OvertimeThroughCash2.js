$(document).ready(function () {
    ...
    var dataSource = new kendo.data.DataSource({
        transport: {
            read: {
                url: "/HrReports/GetOvertimeThroughCash2",
                traditional: true,
                Type: "GET"
            }
        },
    ...
    $("#GridSalariesThroughBanks").kendoGrid({
        ...
        columns: [
            ...
            { field: "payTypeText", title: Resources.PayTypeText, width: Resources.AmountWidth },
...
$(".btnPrint").on('click', function () {
    ...
    var url = "/HrReports/OvertimeThroughCash2Print?fK_HrEmployeeId=" + fK_HrEmployeeId + "&fK_CostCenterId=" + fK_CostCenterId + "&dateFrom=" + dateFrom + "&dateTo=" + dateTo + "&ids=" + ids + "&fK_DefBranchId=" + fK_DefBranchId;

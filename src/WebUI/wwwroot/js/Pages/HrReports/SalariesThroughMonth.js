$(document).ready(function () {
    ...
    var dataSource = new kendo.data.DataSource({
        transport: {
            read: {
                url: "/HrReports/GetSalariesThroughMonth",
                traditional: true,
                Type: "GET"
            }
        },
        ...
        schema: {
            model: {
                ...
                fields: {
                    ...
                    punishmentDays: { editable: false },
                    socialInsuranceDeduction: { editable: false },
                    loanValue: { editable: false },
                    electricityValue: { editable: false },
                    waterValue: { editable: false },
                    housingDeduction: { editable: false },
                    mobileDeduction: { editable: false },
                    otherDeduction: { editable: false },
                    totalDeductions: { editable: false },
                    totalDues: { editable: false },
                }
            }
        }
    });
    $("#GridSalariesThroughBanks").kendoGrid({
        ...
        columns: [
            ...
            { field: "otherDues", title: Resources.OtherDues, width: Resources.AmountWidth },
            {
                ...
                columns: [
                    { field: "punishmentDays", title: Resources.PunishmentDays, width: Resources.AmountWidth },
                    { field: "socialInsuranceDeduction", title: Resources.SocialInsurance, width: Resources.AmountWidth },
                    { field: "loanValue", title: Resources.LoanValue, width: Resources.AmountWidth },
                    { field: "electricityValue", title: Resources.ElectricityValue, width: Resources.AmountWidth },
                    { field: "waterValue", title: Resources.WaterValue, width: Resources.AmountWidth },
                    { field: "housingDeduction", title: Resources.HousingDeduction, width: Resources.AmountWidth },
                    { field: "mobileDeduction", title: Resources.MobileDeduction, width: Resources.AmountWidth },
                    { field: "otherDeduction", title: Resources.OtherDeduction, width: Resources.AmountWidth },

                ]
            },
            { field: "totalDeductions", title: Resources.TotalDeductions, width: Resources.AmountWidth },
            { field: "totalDues", title: Resources.TotalDues, width: Resources.AmountWidth },
...
$(".btnPrint").on('click', function () {
    ...
    var url = "/HrReports/SalariesThroughMonthPrint?fK_HrEmployeeId=" + fK_HrEmployeeId + "&fK_CostCenterId=" + fK_CostCenterId + "&dateFrom=" + dateFrom + "&dateTo=" + dateTo + "&ids=" + ids + "&fK_DefBranchId=" + fK_DefBranchId;

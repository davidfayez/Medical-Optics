$(document).ready(function () {
    ...
    var dataSource = new kendo.data.DataSource({
        transport: {
            read: {
                url: "/HrReports/GetSalariesThroughBanks",
                traditional: true,
                Type: "GET"
            }
        },
...
$(".btnPrint").on('click', function () {
    ...
    var url = "/HrReports/SalariesThroughBanksPrint?fK_HrEmployeeId=" + fK_HrEmployeeId + "&fK_CostCenterId=" + fK_CostCenterId + "&dateFrom=" + dateFrom + "&dateTo=" + dateTo + "&ids=" + ids + "&fK_DefBranchId=" + fK_DefBranchId;

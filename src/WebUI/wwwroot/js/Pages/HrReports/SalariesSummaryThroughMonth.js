$(document).ready(function () {
    ...
    var dataSource = new kendo.data.DataSource({
        transport: {
            read: {
                url: "/HrReports/GetSalariesSummaryThroughMonth",
                traditional: true,
                Type: "GET"
            }
        },
        ...
        schema: {
            model: {
                ...
                fields: {
                    id: { editable: false },
                    managementNameAr: { type: "string" },
                    basicSalary: { editable: false },
                    totalAllowances: { editable: false },
    ...
    $("#GridSalariesThroughBanks").kendoGrid({
        ...
        columns: [
            { field: "managementNameAr", title: Resources.ManagementNameAr, width: Resources.NameWidth },
            { field: "basicSalary", title: Resources.BasicSalary, width: Resources.AmountWidth },
            { field: "totalAllowances", title: Resources.TotalAllowances, width: Resources.AmountWidth },
...
$(".btnPrint").on('click', function () {
    ...
    var url = "/HrReports/SalariesSummaryThroughMonthPrint?fK_HrEmployeeId=" + fK_HrEmployeeId + "&fK_CostCenterId=" + fK_CostCenterId + "&dateFrom=" + dateFrom + "&dateTo=" + dateTo + "&ids=" + ids + "&fK_DefBranchId=" + fK_DefBranchId;

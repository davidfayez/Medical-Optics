$(document).ready(function () {
    ...
    function loadArchiveLevelGrid() {
        var dataSource = new kendo.data.DataSource({
            transport: {
                read: {
                    url: "/HrArchive/GetAllArchiveLevel2",
                    Type: "GET"
                }
            },
            error: function (e) {
        ...
        var grid = $("#archiveLevel2Grid").kendoGrid({
            excel: {
            ...
            columns: [
                ...
                },
                {
                    ...
                    template: "<a  href='/HrArchive/EditArchiveLevel2/#= id #'  class='btn btn-success btn-sm btnEdit'><i class='fas fa-edit'></i></a> <a  class='btn btn-danger btn-sm btnDelete' ><i class='fas fa-trash-alt'></i></a>"
    ...
    function removeArchiveLevel() {
        ...
        var row = $(this).closest("tr"),
            grid = $("#archiveLevel2Grid").data("kendoGrid"),
        ...
        swal({
            ...
            setTimeout(function () {
                $.ajax({
                    url: "/HrArchive/DeleteArchiveLevel2?Id=" + dataItem.id,
                    type: "Get",
    ...
    $("#DefBranches").change(function () {
        ...
        $('#archiveLevel2Grid').data('kendoGrid').dataSource.read({ fK_DefBranchId: fK_DefBranchId });
    });
});
$(".exportExcel").on('click', function () {
    $("#archiveLevel2Grid").getKendoGrid().saveAsExcel();
});
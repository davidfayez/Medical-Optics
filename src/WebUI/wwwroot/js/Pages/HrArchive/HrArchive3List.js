$(document).ready(function () {
    ...
    function loadArchiveLevelGrid() {
        var dataSource = new kendo.data.DataSource({
            transport: {
                read: {
                    url: "/HrArchive/GetAllArchiveLevel3",
                    Type: "GET"
                }
            },
            error: function (e) {
        ...
        var grid = $("#archiveLevel2Grid").kendoGrid({
            ...
            columns: [
                ...
                },
                {
                    ...
                    template: "<a  href='/HrArchive/EditArchiveLevel3/#= id #'  class='btn btn-success btn-sm btnEdit'><i class='fas fa-edit'></i></a> <a  class='btn btn-danger btn-sm btnDelete' ><i class='fas fa-trash-alt'></i></a>"
    ...
    function removeArchiveLevel() {
        ...
        swal({
            ...
            setTimeout(function () {
                $.ajax({
                    url: "/HrArchive/DeleteArchiveLevel3?Id=" + dataItem.id,
                    type: "Get",

$(document).ready(function () {
    ...
    function loadArchiveLevelGrid() {
        var dataSource = new kendo.data.DataSource({
            transport: {
                read: {
                    url: "/HrArchive/GetAllArchiveAddFile",
                    Type: "GET"
                }
            },
            error: function (e) {
        ...
        var grid = $("#archiveLevel2Grid").kendoGrid({
            ...
            columns: [
                ...
                { field: "fileName", title: Resources.NameArResource, width: Resources.NameWidth },
        ...
        grid.data("kendoGrid").table.on("click", ".btnDelete", removeArchiveFile);
    }

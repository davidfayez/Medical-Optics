$(document).ready(function () {
    ...
    loadFavoritesDiagnosisGrid();

    function loadFavoritesDiagnosisGrid() {
        ...
        var grid = $("#FavoritesDiagnosisGrid").kendoGrid({
            excel: {
                fileName: "diagnoses.xlsx",
            ...
            columns: [
                ...
                },
                {
                    ...
                    template: "<a  href='/FavoriteDiagnose/Edit/#= id #'  class='btn btn-success btn-sm btnEdit'><i class='fas fa-edit'></i></a> <a  class='btn btn-danger btn-sm btnDelete' ><i class='fas fa-trash-alt'></i></a>"
    ...
    function removediagnose() {
        ...
        var row = $(this).closest("tr"),
            grid = $("#FavoritesDiagnosisGrid").data("kendoGrid"),
        ...
        swal({
            ...
            setTimeout(function () {
                $.ajax({
                    url: "/Favoritediagnose/Delete?Id=" + dataItem.id,
                    type: "Post",
...
$(".exportExcel").on('click', function () {
    $("#FavoritesDiagnosisGrid").getKendoGrid().saveAsExcel();
});
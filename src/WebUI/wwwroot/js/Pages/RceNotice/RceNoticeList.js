$(document).ready(function () {
    ...
    $("#DefBranches").change(function () {
        ...
        $('#rceNoticeGrid').data('kendoGrid').dataSource.read({ fK_DefBranchId: fK_DefBranchId });
    });

    loadRceNoticeGrid();

    function loadRceNoticeGrid() {
        var dataSource = new kendo.data.DataSource({
            transport: {
                read: {
                    url: "/RceNotice/GetAll",
                    Type: "GET"
                }
            },
            error: function (e) {
        ...
        var grid = $("#rceNoticeGrid").kendoGrid({
            excel: {
                fileName: "Notice.xlsx",
            ...
            columns: [
                ...
                { field: "serial", title: Resources.Code, width: Resources.CodeWidth },
                ...
                { width: Resources.CheckboxWidth, template: "<input type='checkbox' data-bind='checked:isSubClient' class= 'control-label i-check' disabled = 'disabled' />", headerTemplate: Resources.SubClientResource },
                { field: "gross", title: Resources.GrossResource, width: "190px" },
                ...
                { width: Resources.DoubleActionWidth, template: "<a  href='/RceNotice/Edit/#= id #'  class='btn btn-success btn-sm btnEdit'><i class='fas fa-edit'></i></a> <a  class='btn btn-danger btn-sm btnDelete ' ><i class='fas fa-trash-alt'></i></a> <a  class='btn btn-warning btn-sm btnOpenVoucherReport'><i class='fas fa-eye'></i></a>" },
        ...
        grid.data("kendoGrid").table.on("click", ".btnDelete", removeRceNotice);
    ...
    function OpenVoucherReport() {
        ...
        var row = $(this).closest("tr"),
            grid = $("#rceNoticeGrid").data("kendoGrid"),
    ...
    function removeRceNotice() {
        ...
        swal({
            ...
            setTimeout(function () {
                $.ajax({
                    url: "/RceNotice/Delete?Id=" + dataItem.id,
                    type: "Get",
...
$(".exportExcel").on('click', function () {
    $("#rceNoticeGrid").getKendoGrid().saveAsExcel();
});
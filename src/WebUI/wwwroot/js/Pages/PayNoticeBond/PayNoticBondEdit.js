$(document).ready(function () {
    ...
    function loadPayNoticeBondDetailsGrid(suppId) {
        ...
        var dataSource = new kendo.data.DataSource({
            ...
            transport: {
                read: {
                    url: "/PayNoticeBond/GetAllPayInvoices?supplierId=" + suppId + "&dateFrom=" + $("#DateFrom").val() + "&dateTo=" + $("#DateTo").val() + "&noticeId=" + parseInt($("#Id").val()) + "&branchId=" + parseInt($("#FK_DefBranchId").val()),
                    Type: "GET"
                }
            },
            error: function (e) {
...
function SubmitPayNoticeBondEdit() {

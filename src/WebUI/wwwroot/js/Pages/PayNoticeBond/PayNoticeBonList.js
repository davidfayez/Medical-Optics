$(document).ready(function () {
    ...
    loadPayNoticeBondGrid();

    function loadPayNoticeBondGrid() {
        var dataSource = new kendo.data.DataSource({
            transport: {
                read: {
                    url: "/PayNoticeBond/GetAll",
                    Type: "GET"
                }
            },
            error: function (e) {
        ...
        var grid = $("#PayNoticeBondGrid").kendoGrid({
            excel: {
            ...
            columns: [
              ...
              //  { field: "remaining", title: Resources.RemainingResource, width: Resources.AmountWidth },
               // { field: "downPayment", title: Resources.DownPaymentResource, width: Resources.AmountWidth },
                ...
                { width: Resources.DoubleActionWidth, template: "<a  href='/PayNoticeBond/Edit/#= id #'  class='btn btn-success btn-sm btnEdit'><i class='fas fa-edit'></i></a> <a  class='btn btn-danger btn-sm btnDelete ' ><i class='fas fa-trash-alt'></i></a>  <a  class='btn btn-warning btn-sm btnOpenVoucherReport'><i class='fas fa-eye'></i></a>" },
    ...
    function removePayNoticeBond() {
        ...
        var row = $(this).closest("tr"),
            grid = $("#PayNoticeBondGrid").data("kendoGrid"),
        ...
        swal({
            ...
            setTimeout(function () {
                $.ajax({
                    url: "/PayNoticeBond/Delete?id=" + dataItem.id,
                    type: "Get",
    ...
    $("#DefBranches").change(function () {
        ...
        $('#PayNoticeBondGrid').data('kendoGrid').dataSource.read({ fK_DefBranchId: fK_DefBranchId });
    });

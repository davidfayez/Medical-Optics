$().ready(function () {
    ...
    function LoadGridBondDetails() {
        tempSource = new kendo.data.DataSource({
            transport: {
                read: {
                    url: "/TaxsAdjustmentBond/GetBondDetailsById?id=" + id,
                    Type: "GET"
                },
            ...
            schema: {
                model: {
                    ...
                    fields: {
                        id: { editable: true },
                        fK_GlAccountIdFromId: { editable: false },
                        fK_GlAccountIdToId: { editable: false },
                        toAccountCode: { type: "text", editable: false },
                        toAccountName: { type: "text", editable: false },
        ...
        var gridBound = $("#GridTaxsBondDetails").kendoGrid({
            ...
            columns: [
                ...
                { field: "fK_GlAccountIdFromId", hidden: true },
    ...
    function removeBondDetailRow() {
        ...
        var row = $(this).closest("tr"),
            ...
            dataSource = $("#GridTaxsBondDetails").data("kendoGrid").dataSource;
        swal({
            ...
            if (detailId != "" && detailId != null) {
                setTimeout(function () {
                    $.ajax({
                        url: "/TaxsAdjustmentBond/DeleteBondDetail?id=" + detailId,
                        type: "Get",
...
function SubmitTaxsBondEdit() {

    if ($("#FormTaxsAdjustmentBondEdit").valid()) {
        var listDetails = [];

$(document).ready(function () {
    ...
    function loadCreditMachineGrid() {
        var dataSource = new kendo.data.DataSource({
            transport: {
                read: {
                    url: "/CbCreditMachine/GetAllCreditMachine",
                    Type: "GET"
                }
            },
            error: function (e) {
            ...
            schema: {
                model: {
                    ...
                    fields: {
                        id: { editable: false },
                        machineCode: { editable: false },
                        machineNameAr: { editable: false },
                        machineNameEn: { editable: false },
        ...
        var grid = $("#CreditMachineGrid").kendoGrid({
            ...
            columns: [
                ...
                {
                    field: "machineCode", title: Resources.CodeResource, width: Resources.CodeWidth },
                { field: "machineNameAr", title: Resources.NameArResource, width: Resources.NameWidth },
                { field: "machineNameEn", title: Resources.NameEnResource, width: Resources.NameWidth },
                ...
                { width: Resources.DoubleActionWidth, template: "<a  href='/CbCreditMachine/Edit/#= id #'  class='btn btn-success btn-sm btnEdit'><i class='fas fa-edit'></i></a> <a  class='btn btn-danger btn-sm btnDelete ' ><i class='fas fa-trash-alt'></i></a>" },
    ...
    function removeCreditMachine() {
        ...
        swal({
            ...
            setTimeout(function () {
                $.ajax({
                    url: "/CbCreditMachine/Delete?Id=" + dataItem.id,
                    type: "Get",

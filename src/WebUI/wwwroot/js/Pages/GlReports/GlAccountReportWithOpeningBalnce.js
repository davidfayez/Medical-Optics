$(document).ready(function () {
    ...
    var dataSource = new kendo.data.TreeListDataSource({
        transport: {
            read: {
                url: "/GlReports/GetGlAccountReportWithOpeningBalnce",
                dataType: "json",
                Type: "GET"
            },
            parameterMap: function (data, action) {
    ...
    var treeList = $("#GridGlAccountReportWithOpeningBalnce").kendoTreeList({
        dataSource: dataSource,
        pageable: true,
        excel: {
            fileName: "Gl Account Report With Opening Balnce.xlsx",
            allPages: true,
            filterable: true
        },
        pageSize: 20,
    ...
    /*    $('#GridGlAccountReportWithOpeningBalnce').data('kendoTreeList').dataSource.page(1);*/
    function OpenDetails() {
        var row = $(this).closest("tr"),
            grid = $("#GridGlAccountReportWithOpeningBalnce").data("kendoTreeList"),
    ...
    $("#btnDataReview").on('click', function () {
        ...
        $('#GridGlAccountReportWithOpeningBalnce').data('kendoTreeList').dataSource.read();
...
$(".exportExcel").on('click', function () {
    $("#GridGlAccountReportWithOpeningBalnce").getKendoGrid().saveAsExcel();
});
...
function SetSummary() {
    ...
    var treeReport = $("#GridGlAccountReportWithOpeningBalnce").data("kendoTreeList")

$(document).ready(function () {
    ...
    var dataSource = new kendo.data.TreeListDataSource({
        transport: {
            read: {
                url: "/GlReports/GetTradeAndProfitsAndLossesReport",
                dataType: "json",
                Type: "GET"
            },
            parameterMap: function (data, action) {
    ...
    $("#GridTradeAndProfitsAndLossesReport").kendoTreeList({
        excel: {
    ...
    //$('#GridTradeAndProfitsAndLossesReport').data('kendoTreeList').dataSource.page(1); // select current page


});

$(".exportExcel").on('click', function () {
    $("#GridTradeAndProfitsAndLossesReport").getKendoGrid().saveAsExcel();
});
...
$("#btnDataReview").on('click', function () {
    ...
    if (multiCategories.length > 0) {
        ...
        $('#GridTradeAndProfitsAndLossesReport').data('kendoTreeList').dataSource.read();
    }
    else {
        swal({
...
$(".btnPrint").on('click', function () {
    ...
    if (multiCategories.length > 0) {
        var url = "/GlReports/TradeAndProfitsAndLossesReportPrint?dateFrom=" + dateFrom + "&dateTo=" + dateTo + "&isPosted=" + isPosted + "&isTotalAccountZero=" + isTotalAccountZero + "&IsSubAccountSupport=" + isSubAccountSupport + "&fK_DefBranchId=" + fK_DefBranchId + "&multiCategories=" + multiCategories + "&fK_GlAccountTypeId=" + fK_GlAccountTypeId;
...
function SetSummary() {
    ...
    var treeReport = $("#GridTradeAndProfitsAndLossesReport").data("kendoTreeList")

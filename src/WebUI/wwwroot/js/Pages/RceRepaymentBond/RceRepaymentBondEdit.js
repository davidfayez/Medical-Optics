$().ready(function () {
    ...
    $('#TotalAmount').change(function () {
        ...
        var prevFK_RceClientId = parseInt($("#prevFK_RceClientId").val());
        var currentFK_RceClientId = parseInt($("#FK_RceClientId").val());

        if (currentFK_RceClientId == prevFK_RceClientId) {
    ...
    function loadRceRepaymentDetailsGrid(clientId) {
        ...
        var dataSource = new kendo.data.DataSource({
            ...
            transport: {
                read: {
                    url: "/RceRepaymentBond/GetAllRceReference?clientId=" + clientId + "&bondId=" + parseInt($("#Id").val()) + "&branchId=" + parseInt($("#FK_DefBranchId").val()),
                    Type: "GET"
                }
            },
            error: function (e) {
        ...
        var grid = $("#GridRceRepayment").kendoGrid({
            excel: {
                fileName: "client Repayments.xlsx",
...
function checkPeriodAndSaveRceRepaymentBondEdit() {
...
function SubmitRceRepaymentBondEdit() {

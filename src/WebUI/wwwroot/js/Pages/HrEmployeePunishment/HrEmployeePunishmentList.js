$(document).ready(function () {
    ...
    function loadBonusGrid() {
        var dataSource = new kendo.data.DataSource({
            transport: {
                read: {
                    url: "/HrEmployeePunishment/GetAll",
                    Type: "GET"
                }
            },
            error: function (e) {
        ...
        grid.data("kendoGrid").table.on("click", ".btnRetrieve", retrievePunishment);
    }
    ...
    function removeEmployeeBonus() {
        ...
        swal({
            ...
            setTimeout(function () {
                $.ajax({
                    url: "/HrEmployeePunishment/Delete?Id=" + dataItem.id,
                    type: "Get",
    ...
    function retrievePunishment() {
        ...
        swal({
            ...
            setTimeout(function () {
                $.ajax({
                    url: "/HrEmployeePunishment/Retrieve?id=" + dataItem.id,
                    type: "Get",
                    contentType: 'application/json; charset=utf-8',
                    success: function (result) {
                        debugger;

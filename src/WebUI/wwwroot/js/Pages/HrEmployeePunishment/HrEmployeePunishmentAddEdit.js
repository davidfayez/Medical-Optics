...
$("#btnSubmit").on('click', function () {
    ...
    if ($("#FK_HrDeductionTypeId").val() == 0)
        $("#FK_HrDeductionTypeIdValidation").show();
    else
        $("#FK_HrDeductionTypeIdValidation").hide();
    ...
    if ($("#formEmployeePunishment").valid() && $("#FK_HrEmployeeId").val() > 0 && $("#FK_HrDeductionTypeId").val() > 0 && $("#FK_GranterId").val() > 0) {
        $("#formEmployeePunishment").submit();
    }
});
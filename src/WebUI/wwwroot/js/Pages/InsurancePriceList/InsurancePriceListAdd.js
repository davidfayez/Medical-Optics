$(document).ready(function () {
    $('input[type=radio][name=itemType]').change(function () {
        if (this.value == 'excel') {
            ...
            document.getElementById("divfileupload").style.display = "flex";
        }
    ...
    $("#btnSaveTransaction").click(function () {
        var returnType = $('input[type=radio][name=itemType]:checked').val();
        if (returnType == 'excel') {
            ...
            if ($("#mainForm").valid() && files.length > 0) {
                var tran = {
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        if (result > 0) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: '/InsurancePriceList/UploadPricList',
                                contentType: false,
                                processData: false,
                                data: data,
                                success: function (filsresult) {
                                    console.log(filsresult);
                                    swal({

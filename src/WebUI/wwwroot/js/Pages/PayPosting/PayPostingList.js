$(document).ready(function () {
    ...
    var url = "/PayPosting/GetAllPaysByDate";
    loadAllBonds();
    $("#btnShowBonds").click(function () {

        url = "/PayPosting/GetAllPaysByDate?from=" + $("#txtFrom").val() + "&&to=" + $("#txtTo").val() + "&&id=" + $("#selectBond").val() + "&&fK_DefBranchId=" + $("#FK_DefBranchId").val() + "&&posted="+ $("input[name='IsPosted']:checked").val(); 
        loadAllBonds();
    ...
    function loadAllBonds() {
        $("#payBondsGrid").kendoGrid({
            ...
            columns: [
                ...
                {
                    field: "paySupplierName",
                    title: Resources.SupplierNameResource,
    ...
    $("#selectBond").kendoDropDownList({
        ...
        dataSource: {
            ...
            transport: {
                read: {
                    url: "/PayPosting/GetAllBondTypeForDDL",
                },
    ...
    $("#submitPostedBonds").bind("click", function () {
        ...
        swal({
            ...
            setTimeout(function () {
                $.ajax({
                    url: '/PayPosting/UpdatePaysPosting',
                    type: 'POST',
                    data: { pays: data, id: $("#selectBond").val() },
    ...
    $("#submitCancelPostedBonds").bind("click", function () {
        ...
        swal({
            ...
            setTimeout(function () {
                $.ajax({
                    url: '/PayPosting/UpdatePaysUnposting',
                    type: 'POST',
                    data: { pays: data, id: $("#selectBond").val() },
                    success: function (result) {

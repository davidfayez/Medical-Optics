$(document).ready(function () {
    ...
    var url = "/TaxPosting/GetAllTaxBondByDate";
    loadAllBonds();
    $("#btnShowBonds").click(function () {

        url = "/TaxPosting/GetAllTaxBondByDate?from=" + $("#txtFrom").val() + "&&to=" + $("#txtTo").val() + "";
        loadAllBonds();

    });
    function loadAllBonds() {
        $("#taxBondsGrid").kendoGrid({
            dataSource: {
                //type: "jsonp",
                transport: {
                    read: url
                ...
                schema: {
                    model: {
                        ...
                        fields: {
                            ...
                            fK_GlAccountNameFrom: { type: "string" },
                            fK_GlAccountNameTo: { type: "string" },
            ...
            columns: [
                ...
                {                                              
                    field: "fK_GlAccountNameFrom",
                    title: Resources.AccountName,
                    width: Resources.NameWidth
                },
                //{
                //    field: "fK_GlAccountNameTo",
                //    title: Resources.ToAccountResource,
                //    width: Resources.NameWidth
                //},
                {
                    field: "gross",
    ...
    $("#taxBondsGrid").data("kendoGrid").table.on("click", ".row-checkbox", selectRow);
    ...
    $("#submitPostedBonds").bind("click", function () {
        ...
        swal({
            ...
            setTimeout(function () {
                $.ajax({
                    url: '/TaxPosting/UpdateTaxBondPosting',
                    type: 'POST',
                    data: { bonds: data },
    ...
    $("#submitCancelPostedBonds").bind("click", function () {
        ...
        swal({
            ...
            setTimeout(function () {
                $.ajax({
                    url: '/TaxPosting/UpdateTaxBondUnposting',
                    type: 'POST',
                    data: { bonds: data },
                    success: function (result) {
    ...
    function getCheckedData() {
        var editedData = [];
        gridData = $("#taxBondsGrid").data("kendoGrid").dataSource._data;
...
function selectRow() {
    var checked = this.checked,
        row = $(this).closest("tr"),
        grid = $("#taxBondsGrid").data("kendoGrid"),

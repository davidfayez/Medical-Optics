$(document).ready(function () {
    ...
    function loadDefCountryGrid() {
        ...
        var grid = $("#DefCountryGrid").kendoGrid({
            excel: {
                fileName: "DefCountry.xlsx",
            ...
            columns: [
                ...
                { field: "countryCode", title: Resources.CodeResource, width: Resources.CodeWidth },
                ...
                },
                {
                    ...
                    template: "<a  href='/DefCountry/Edit/#= id #'  class='btn btn-success btn-sm btnEdit'><i class='fas fa-edit'></i></a> <a  class='btn btn-danger btn-sm btnDelete' ><i class='fas fa-trash-alt'></i></a>"
        ...
        grid.data("kendoGrid").table.on("click", ".btnDelete", removeDefCountry);
    }

    function removeDefCountry() {

        //var deletee = stringify(resources.delete).serialize();

        var row = $(this).closest("tr"),
            grid = $("#DefCountryGrid").data("kendoGrid"),
...
$(".exportExcel").on('click', function () {
    $("#DefCountryGrid").getKendoGrid().saveAsExcel();
});
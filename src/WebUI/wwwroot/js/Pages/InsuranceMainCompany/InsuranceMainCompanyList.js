$(document).ready(function () {
    ...
    LoadGridInsuranceMainCompany();
    function LoadGridInsuranceMainCompany() {
        var grid = $("#GridInsuranceMainCompany").kendoGrid({
            excel: {
                fileName: "Insurance Main Companies.xlsx",
                allPages: Resources.GridAllPages,
                filterable: Resources.GridFilterable
            },
            dataSource: {
                transport: {
                    read: "/InsuranceMainCompany/GetAll"
                },
                schema: {
                    model: {
                        id: "id",
            ...
            {
                width: Resources.DoubleActionWidth, template: "<a  href='/InsuranceMainCompany/Edit/#= id #'  class='btn btn-success btn-sm btnEdit'><i class='fas fa-edit'></i></a> <a  class='btn btn-danger btn-sm btnDelete' ><i class='fas fa-trash-alt'></i></a>"
            },
    ...
    function removeColor() {
        ...
        var row = $(this).closest("tr"),
            grid = $("#GridInsuranceMainCompany").data("kendoGrid"),
        ...
        swal({
            ...
            setTimeout(function () {
                $.ajax({
                    url: "/InsuranceMainCompany/Delete?id=" + dataItem.id,
                    type: "Get",
...
$(".exportExcel").on('click', function () {
    $("#GridInsuranceMainCompany").getKendoGrid().saveAsExcel();
});
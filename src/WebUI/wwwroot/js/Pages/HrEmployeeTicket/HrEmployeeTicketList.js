$(document).ready(function () {
    $("#DefBranches").change(function () {
        ...
        $('#HrEmployeeTicketGrid').data('kendoGrid').dataSource.read({ fK_DefBranchId: fK_DefBranchId });
    });
    ...
    function loadGrid() {
            ...
            schema: {
                model: {
                    ...
                    fields: {
                        ...
                        dateDue: { type: "date", editable: false },
        ...
        var grid = $("#HrEmployeeTicketGrid").kendoGrid({
            excel: {
            ...
            columns: [
                ...
                {
                    field: "dateDue", title: Resources.BillDueDateResource, format: "{0:yyyy/MM/dd}", width: Resources.DateWidth,
                    filterable: {
                        operators: {
                            date: {
        ...
        grid.data("kendoGrid").table.on("click", ".btnDelete", removeEmployeeTicket);
        grid.data("kendoGrid").table.on("click", ".btnRetrieve", retrieveTicket);
    }

    function removeEmployeeTicket() {

        //var deletee = stringify(resources.delete).serialize();

        var row = $(this).closest("tr"),
            grid = $("#HrEmployeeTicketGrid").data("kendoGrid"),
        ...
        swal({
            ...
            setTimeout(function () {
                $.ajax({
                    url: "/HrEmployeeTicket/Delete?Id=" + dataItem.id,
                    type: "Get",
    ...
    function retrieveTicket() {
        ...
        swal({
            ...
            setTimeout(function () {
                $.ajax({
                    url: "/HrEmployeeTicket/Retrieve?id=" + dataItem.id,
                    type: "Get",
                    contentType: 'application/json; charset=utf-8',
                    success: function (result) {
                        debugger;
...
$(".exportExcel").on('click', function () {
    $("#HrEmployeeTicketGrid").getKendoGrid().saveAsExcel();
});
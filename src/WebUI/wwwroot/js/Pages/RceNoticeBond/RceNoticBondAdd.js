$(document).ready(function () {
    ...
    function loadRceNoticeBondDetailsGrid(clientId) {
        ...
        var dataSource = new kendo.data.DataSource({
            ...
            transport: {
                read: {
                    url: "/RceNoticeBond/GetAllRceInvoices?clientId=" + clientId + "&dateFrom=" + $("#DateFrom").val() + "&dateTo=" + $("#DateTo").val() + "&branchId=" + parseInt($("#FK_DefBranchId").val()),
                    Type: "GET"
                }
            },
            error: function (e) {
...
function SubmitRceNoticeBondCreate() {

$(document).ready(function () {
    ...
    function getPrevEmployee() {
        ...
        $.ajax({
            url: "/HrEmployee/GetPreviousEmployee?id=" + id + "&&branchId=" + branchId + "&&managementId=" + managementId + "&&departmentId=" + departmentId + "&&display=" + display + "&&entryDate=" + entryDate,
            success: function (result) {
                ...
                if (result) {
                    ...
                    getEmployeeCardData(result.emp.id);
    ...
    function getNextEmployee() {
        ...
        var id = $("#FK_HrEmployeeId").val(),
            ...
            departmentId = $("#FK_HrDepartmentId").val();
        $.ajax({
            url: "/HrEmployee/GetNextEmployee?id=" + id + "&&branchId=" + branchId + "&&managementId=" + managementId + "&&departmentId=" + departmentId + "&&display=" + display + "&&entryDate=" + entryDate,
            success: function (result) {
    ...
    function getFisrtEmployee() {
        var id = $("#FK_HrEmployeeId").val(),
            ...
            departmentId = $("#FK_HrDepartmentId").val();
        $.ajax({
            url: "/HrEmployee/GetFirstEmployee?id=" + id + "&&branchId=" + branchId + "&&managementId=" + managementId + "&&departmentId=" + departmentId + "&&display=" + display + "&&entryDate=" + entryDate,
            success: function (result) {
    ...
    function getLastEmployee() {
        var id = $("#FK_HrEmployeeId").val(),
            ...
            departmentId = $("#FK_HrDepartmentId").val();
        $.ajax({
            url: "/HrEmployee/GetLastEmployee?id=" + id + "&&branchId=" + branchId + "&&managementId=" + managementId + "&&departmentId=" + departmentId + "&&display=" + display + "&&entryDate=" + entryDate,
            success: function (result) {
    ...
    $("#btnSearchCode").click(function () {
        ...
        if (code == "") {
            ...
            $.ajax({
                url: "/HrEmployee/GetEmployeeByCode?code=" + code + "&&branchId=" + branchId + "&&managementId=" + managementId + "&&departmentId=" + departmentId + "&&display=" + display + "&&entryDate=" + entryDate,
                success: function (result) {
...
function getEmployeeSalaryData(id) {
    $.ajax({
        url: "/HrEmployeeSalaryCard/GetEmployeeSalary?id=" + id + "&&day=" + $("#SalaryDate").val(),

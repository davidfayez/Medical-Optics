$(document).ready(function () {
    ...
    loadStBranchExchangeGrid();

    function loadStBranchExchangeGrid() {
        var dataSource = new kendo.data.DataSource({
            transport: {
                read: {
                    url: "/StTransaction/GetAllStBranchExchange",
                    Type: "GET"
                }
            },
            error: function (e) {
        ...
        var grid = $("#StBranchExchangeGrid").kendoGrid({
            excel: {
            ...
            columns: [
                ...
                { width: Resources.DoubleActionWidth, template: "<a  href='/StTransaction/EditBranchExchange/#= id #'  class='btn btn-success btn-sm btnEdit'><i class='fas fa-edit'></i></a> <a  class='btn btn-danger btn-sm btnDelete ' ><i class='fas fa-trash-alt'></i></a>" },
    ...
    function removeStBrand() {
        ...
        var row = $(this).closest("tr"),
            grid = $("#StBranchExchangeGrid").data("kendoGrid"),
        ...
        swal({
            ...
            setTimeout(function () {
                $.ajax({
                    url: "/StTransaction/DeleteBranchExchangeWithDetails?Id=" + dataItem.id,
                    type: "Get",
...
$(".exportExcel").on('click', function () {
    $("#StBranchExchangeGrid").getKendoGrid().saveAsExcel();
});
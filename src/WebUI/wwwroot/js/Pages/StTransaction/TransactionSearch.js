$(document).ready(function () {
    ...
    var invoiceType = $("input[type='radio'][name='Invoice-Type']:checked").val();
    var payType = $("input[type='radio'][name='Pay-Type']:checked").val();


    debugger
    url = "/StTransaction/GetAll?dateFrom=" + dateFrom + "&dateTo=" + dateTo + "&serialNumber=" + serialNumber + "&phone=" + phone + "&companyName=" + companyName + "&fK_RceClientId=" + fK_RceClientId + "&fK_HrEmployeeId=" + fK_HrEmployeeId + "&fK_DefBranchId=" + fK_DefBranchId + "&invoiceType=" + invoiceType + "&payType=" + payType
    ...
    function loadSearchGrid() {
        ...
        var grid = $("#SearchGrid").kendoGrid({
            ...
            columns: [
                ...
                {
                    field: "transactionDate", title: Resources.OfferDate, format: "{0:yyyy/MM/dd}", width: Resources.DateWidth,
                    filterable: {
                        operators: {
                            date: {
                ...
                {
                    width: Resources.DoubleActionWidth, template: "<a  href='/#= controllerName #/Edit/#= id #'  class='btn btn-success btn-sm btnEdit'><i class='fas fa-edit'></i></a> "
                },

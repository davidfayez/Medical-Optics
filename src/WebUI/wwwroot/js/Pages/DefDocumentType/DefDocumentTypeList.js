$(document).ready(function () {
    ...
    loadDefDocumentTypeGrid();

    function loadDefDocumentTypeGrid() {
        var dataSource = new kendo.data.DataSource({
            transport: {
                read: {
                    url: "/DefDocumentType/GetAll",
                    Type: "GET"
                }
            },
            error: function (e) {
        ...
        var grid = $("#GridDefDocumentType").kendoGrid({
            excel: {
                fileName: "Document Types.xlsx",
                allPages: true,
                filterable: true
            },
            ...
            columns: [
                ...
                { field: "secModuleName", title: Resources.SecModuleResource, width: Resources.NameWidth },
                ...
                {
                    width: Resources.DoubleActionWidth, template: "<a  href='/DefDocumentType/Edit/#= id #'  class='btn btn-success btn-sm btnEdit'><i class='fas fa-edit'></i></a> <a  class='btn btn-danger btn-sm btnDelete' ><i class='fas fa-trash-alt'></i></a>"
                },
    ...
    function removeDocumentType() {
        ...
        var row = $(this).closest("tr"),
            grid = $("#GridDefDocumentType").data("kendoGrid"),
        ...
        swal({
            ...
            setTimeout(function () {
                $.ajax({
                    url: "/DefDocumentType/Delete?Id=" + dataItem.id,
                    type: "Get",
...
$(".exportExcel").on('click', function () {
    $("#GridDefDocumentType").getKendoGrid().saveAsExcel();
});
$(document).ready(function () {
    ...
    function loadStTypeGrid() {
        var dataSource = new kendo.data.DataSource({
            transport: {
                read: {
                    url: "/StLookups/GetAllStType",
                    Type: "GET"
                }
            },
            error: function (e) {
        ...
        var grid = $("#StTypeGrid").kendoGrid({
            ...
            columns: [
                ...
                { width: Resources.DoubleActionWidth, template: "<a  href='/StLookups/EditStType/#= id #'  class='btn btn-success btn-sm btnEdit'><i class='fas fa-edit'></i></a> <a  class='btn btn-danger btn-sm btnDelete ' ><i class='fas fa-trash-alt'></i></a>" },
        ...
        grid.data("kendoGrid").table.on("click", ".btnDelete", removeStType);
    }

    function removeStType() {

        //var deletee = stringify(resources.delete).serialize();

        var row = $(this).closest("tr"),
            grid = $("#StTypeGrid").data("kendoGrid"),
        ...
        swal({
            ...
            setTimeout(function () {
                $.ajax({
                    url: "/StLookups/DeleteStType?Id=" + dataItem.id,
                    type: "Get",
...
$(".exportExcel").on('click', function () {
    $("#StTypeGrid").getKendoGrid().saveAsExcel();
});
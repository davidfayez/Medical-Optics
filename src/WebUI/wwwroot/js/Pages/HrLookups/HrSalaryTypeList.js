$(document).ready(function () {
    ...
    loadHrSalaryTypeGrid();

    function loadHrSalaryTypeGrid() {
        var dataSource = new kendo.data.DataSource({
            transport: {
                read: {
                    url: "/HrLookups/GetAllHrSalaryType",
                    Type: "GET"
                }
            },
            error: function (e) {
        ...
        var grid = $("#hrSalaryTypeGrid").kendoGrid({
            excel: {
                fileName: "Hr Ticket Type.xlsx",
            ...
            columns: [
                ...
                { width: Resources.DoubleActionWidth, template: "<a  href='/HrLookups/EditHrSalaryType/#= id #'  class='btn btn-success btn-sm btnEdit'><i class='fas fa-edit'></i></a> <a  class='btn btn-danger btn-sm btnDelete ' ><i class='fas fa-trash-alt'></i></a>" },
        ...
        grid.data("kendoGrid").table.on("click", ".btnDelete", removeHrSalaryType);
    }

    function removeHrSalaryType() {

        var row = $(this).closest("tr"),
            grid = $("#hrSalaryTypeGrid").data("kendoGrid"),
        ...
        swal({
            ...
            setTimeout(function () {
                $.ajax({
                    url: "/HrLookups/DeleteHrSalaryType?Id=" + dataItem.id,
                    type: "Get",
    ...
    $("#DefBranches").change(function () {
        ...
        $('#hrSalaryTypeGrid').data('kendoGrid').dataSource.read({ fK_DefBranchId: fK_DefBranchId });
    });
});
$(".exportExcel").on('click', function () {
    $("#hrSalaryTypeGrid").getKendoGrid().saveAsExcel();
});
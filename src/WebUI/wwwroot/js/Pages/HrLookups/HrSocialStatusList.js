$(document).ready(function () {
    ...
    loadSocialStatusGrid();

    function loadSocialStatusGrid() {
        var dataSource = new kendo.data.DataSource({
            transport: {
                read: {
                    url: "/HrLookups/GetAllHrSocialStatus",
                    Type: "GET"
                }
            },
            error: function (e) {
        ...
        var grid = $("#socialStatusGrid").kendoGrid({
            excel: {
                fileName: "social Status.xlsx",
            ...
            columns: [
                ...
                },
                {
                    ...
                    template: "<a  href='/HrLookups/EditHrSocialStatus/#= id #'  class='btn btn-success btn-sm btnEdit'><i class='fas fa-edit'></i></a> <a  class='btn btn-danger btn-sm btnDelete' ><i class='fas fa-trash-alt'></i></a>"
        ...
        grid.data("kendoGrid").table.on("click", ".btnDelete", removeSocialStatus);
    }

    function removeSocialStatus() {

        //var deletee = stringify(resources.delete).serialize();

        var row = $(this).closest("tr"),
            grid = $("#socialStatusGrid").data("kendoGrid"),
        ...
        swal({
            ...
            setTimeout(function () {
                $.ajax({
                    url: "/HrLookups/DeleteHrSocialStatus?Id=" + dataItem.id,
                    type: "Get",
    ...
    $("#DefBranches").change(function () {
        ...
        $('#socialStatusGrid').data('kendoGrid').dataSource.read({ fK_DefBranchId: fK_DefBranchId });
    });
});
$(".exportExcel").on('click', function () {
    $("#socialStatusGrid").getKendoGrid().saveAsExcel();
});
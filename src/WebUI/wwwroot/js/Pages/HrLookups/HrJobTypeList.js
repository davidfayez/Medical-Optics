$(document).ready(function () {
    ...
    function loadJobTypeGrid() {
        var dataSource = new kendo.data.DataSource({
            transport: {
                read: {
                    url: "/HrLookups/GetAllHrJobType",
                    Type: "GET"
                }
            },
            error: function (e) {
        ...
        var grid = $("#jobTypeGrid").kendoGrid({
            excel: {
                fileName: "Job Type.xlsx",
            ...
            columns: [
                ...
                },
                {
                    ...
                    template: "# if (isSystem==1){#<a></a>#} else {#<a  href='/HrLookups/EditHrJobType/#= id #'  class='btn btn-success btn-sm btnEdit'><i class='fas fa-edit'></i></a> <a  class='btn btn-danger btn-sm btnDelete' ><i class='fas fa-trash-alt'></i></a>#}#"
        ...
        grid.data("kendoGrid").table.on("click", ".btnDelete", removeJobType);
    }
    ...
    function removeJobType() {
        ...
        swal({
            ...
            setTimeout(function () {
                $.ajax({
                    url: "/HrLookups/DeleteHrJobType?Id=" + dataItem.id,
                    type: "Get",
    ...
    $("#DefBranches").change(function () {
        ...
        $('#jobTypeGrid').data('kendoGrid').dataSource.read({ fK_DefBranchId: fK_DefBranchId });
    });
});
$(".exportExcel").on('click', function () {
    $("#jobTypeGrid").getKendoGrid().saveAsExcel();
});
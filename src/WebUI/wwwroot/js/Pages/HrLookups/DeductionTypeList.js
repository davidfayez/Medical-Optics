$(document).ready(function () {
    ...
    loadDeductionTypeGrid();

    function loadDeductionTypeGrid() {
        var dataSource = new kendo.data.DataSource({
            transport: {
                read: {
                    url: "/HrLookups/GetAllHrDeductionType",
                    Type: "GET"
                }
            },
            error: function (e) {
        ...
        var grid = $("#deductionTypeGrid").kendoGrid({
            excel: {
                fileName: "deduction Type.xlsx",
            ...
            columns: [
                ...
                },
                {
                    ...
                    template: "<a  href='/HrLookups/EditHrDeductionType/#= id #'  class='btn btn-success btn-sm btnEdit'><i class='fas fa-edit'></i></a> <a  class='btn btn-danger btn-sm btnDelete' ><i class='fas fa-trash-alt'></i></a>"
        ...
        grid.data("kendoGrid").table.on("click", ".btnDelete", removeDeductionType);
    }

    function removeDeductionType() {

        //var deletee = stringify(resources.delete).serialize();

        var row = $(this).closest("tr"),
            grid = $("#deductionTypeGrid").data("kendoGrid"),
        ...
        swal({
            ...
            setTimeout(function () {
                $.ajax({
                    url: "/HrLookups/DeleteHrDeductionType?Id=" + dataItem.id,
                    type: "Get",
    ...
    $("#DefBranches").change(function () {
        ...
        $('#deductionTypeGrid').data('kendoGrid').dataSource.read({ fK_DefBranchId: fK_DefBranchId });
    });
});
$(".exportExcel").on('click', function () {
    $("#deductionTypeGrid").getKendoGrid().saveAsExcel();
});
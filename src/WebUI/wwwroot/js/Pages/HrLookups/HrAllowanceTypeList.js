$(document).ready(function () {
    ...
    loadAllowanceTypeGrid();

    function loadAllowanceTypeGrid() {
        var dataSource = new kendo.data.DataSource({
            transport: {
                read: {
                    url: "/HrLookups/GetAllHrAllowanceType",
                    Type: "GET"
                }
            },
            error: function (e) {
        ...
        var grid = $("#allowanceTypeGrid").kendoGrid({
            excel: {
            ...
            columns: [
                ...
                },
                {
                    ...
                    template: "<a  href='/HrLookups/EditHrAllowanceType/#= id #'  class='btn btn-success btn-sm btnEdit'><i class='fas fa-edit'></i></a> <a  class='btn btn-danger btn-sm btnDelete' ><i class='fas fa-trash-alt'></i></a>"
        ...
        grid.data("kendoGrid").table.on("click", ".btnDelete", removeAllowanceType);
    }

    function removeAllowanceType() {

        //var deletee = stringify(resources.delete).serialize();

        var row = $(this).closest("tr"),
            grid = $("#allowanceTypeGrid").data("kendoGrid"),
        ...
        swal({
            ...
            setTimeout(function () {
                $.ajax({
                    url: "/HrLookups/DeleteHrAllowanceType?Id=" + dataItem.id,
                    type: "Get",
    ...
    $("#DefBranches").change(function () {
        ...
        $('#allowanceTypeGrid').data('kendoGrid').dataSource.read({ fK_DefBranchId: fK_DefBranchId });
    });

});
$(".exportExcel").on('click', function () {
    $("#allowanceTypeGrid").getKendoGrid().saveAsExcel();
});
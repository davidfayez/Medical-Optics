$(document).ready(function () {
    ...
    loadHrTicketTypeGrid();

    function loadHrTicketTypeGrid() {
        var dataSource = new kendo.data.DataSource({
            transport: {
                read: {
                    url: "/HrLookups/GetAllHrTicketType",
                    Type: "GET"
                }
            },
            error: function (e) {
        ...
        var grid = $("#hrTicketTypeGrid").kendoGrid({
            excel: {
            ...
            columns: [
                ...
                { width: Resources.DoubleActionWidth, template: "<a  href='/HrLookups/EditHrTicketType/#= id #'  class='btn btn-success btn-sm btnEdit'><i class='fas fa-edit'></i></a> <a  class='btn btn-danger btn-sm btnDelete ' ><i class='fas fa-trash-alt'></i></a>" },
        ...
        grid.data("kendoGrid").table.on("click", ".btnDelete", removeHrTicketType);
    }

    function removeHrTicketType() {

        var row = $(this).closest("tr"),
            grid = $("#hrTicketTypeGrid").data("kendoGrid"),
        ...
        swal({
            ...
            setTimeout(function () {
                $.ajax({
                    url: "/HrLookups/DeleteHrTicketType?Id=" + dataItem.id,
                    type: "Get",
    ...
    $("#DefBranches").change(function () {
        ...
        $('#hrTicketTypeGrid').data('kendoGrid').dataSource.read({ fK_DefBranchId: fK_DefBranchId });
    });
});
$(".exportExcel").on('click', function () {
    $("#hrTicketTypeGrid").getKendoGrid().saveAsExcel();
});
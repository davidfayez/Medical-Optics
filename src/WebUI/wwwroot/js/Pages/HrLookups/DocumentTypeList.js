$(document).ready(function () {
    ...
    loadDocumentTypeGrid();

    function loadDocumentTypeGrid() {
        ...
        var grid = $("#documentTypeGrid").kendoGrid({
            excel: {
                fileName: "document Type.xlsx",
            ...
            columns: [
                ...
                },
                {
                    ...
                    template: "<a  href='/HrLookups/EditHrDocumentType/#= id #'  class='btn btn-success btn-sm btnEdit'><i class='fas fa-edit'></i></a> <a  class='btn btn-danger btn-sm btnDelete' ><i class='fas fa-trash-alt'></i></a>"
        ...
        grid.data("kendoGrid").table.on("click", ".btnDelete", removeDocumentType);
    }

    function removeDocumentType() {
        ...
        swal({
            ...
            setTimeout(function () {
                $.ajax({
                    url: "/HrLookups/DeleteHrDocumentType?Id=" + dataItem.id,
                    type: "Get",
    ...
    $("#DefBranches").change(function () {
        ...
        $('#documentTypeGrid').data('kendoGrid').dataSource.read({ fK_DefBranchId: fK_DefBranchId });
    });
});
$(".exportExcel").on('click', function () {
    $("#documentTypeGrid").getKendoGrid().saveAsExcel();
});
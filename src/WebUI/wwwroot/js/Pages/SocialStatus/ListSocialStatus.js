$(document).ready(function () {
        ...
        var grid = $("#SocialStatusGrid").kendoGrid({
            ...
            columns: [
                ...
                },
                {
                    ...
                    template: "<a  href='/SocialStatus/Edit/#= id #'  class='btn btn-success btn-sm btnEdit'><i class='fas fa-edit'></i></a> <a  class='btn btn-danger btn-sm btnDelete' ><i class='fas fa-trash-alt'></i></a>"
    ...
    function removeSocialStatus() {
        ...
        swal({
            ...
            setTimeout(function () {
                $.ajax({
                    url: "/SocialStatus/Delete?Id=" + dataItem.id,
                    type: "Post",

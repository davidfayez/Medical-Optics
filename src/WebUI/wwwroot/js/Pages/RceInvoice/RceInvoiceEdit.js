$(document).ready(function () {
    ...
    tempSource = new kendo.data.DataSource({
        transport: {
            read: {
                url: "/RceInvoice/GetRceInvoiceDetailsById?id=" + id,
                Type: "GET"
            },
    ...
    var gridBound = $("#RceInvoiceDetailsgrid").kendoGrid({
        ...
        columns: [
            ...
            { field: "Fk_DiscountGlAccountId", hidden: true },
    ...
    function removeBondDetailRow() {
        ...
        var row = $(this).closest("tr"),
            ...
            dataSource = $("#RceInvoiceDetailsgrid").data("kendoGrid").dataSource;
        swal({
            ...
            if (detailId != "" && detailId != null) {
                setTimeout(function () {
                    $.ajax({
                        url: "/RceInvoice/DeleteInvoiceDetail?id=" + detailId,
                        type: "Get",
...
function checkPeriodAndSubmitRceInvoiceEdit() {
...
$("#btnPrint").on('click', function () {
    ...
    var url = "/RceInvoice/ReportPrint?id=" + $("#Id").val();

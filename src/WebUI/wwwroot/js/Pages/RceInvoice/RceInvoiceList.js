$(document).ready(function () {
    ...
    $("#DefBranches").change(function () {
        ...
        $('#GridRceInvoice').data('kendoGrid').dataSource.read({ fK_DefBranchId: fK_DefBranchId });
    });

    loadRceInvoiceGrid();

    function loadRceInvoiceGrid() {
        var dataSource = new kendo.data.DataSource({
            transport: {
                read: {
                    url: "/RceInvoice/GetAll",
                    Type: "GET"
                }
            },
            error: function (e) {
        ...
        var grid = $("#GridRceInvoice").kendoGrid({
            excel: {
            ...
            columns: [
                ...
                { width: Resources.DoubleActionWidth, template: "<a  href='/RceInvoice/Edit/#= id #'  class='btn btn-success btn-sm btnEdit'><i class='fas fa-edit'></i></a> <a  class='btn btn-danger btn-sm btnDelete ' ><i class='fas fa-trash-alt'></i></a> <a  class='btn btn-warning btn-sm btnOpenVoucherReport'><i class='fas fa-eye'></i></a>" },
    ...
    function OpenVoucherReport() {
        ...
        var row = $(this).closest("tr"),
            grid = $("#GridRceInvoice").data("kendoGrid"),
    ...
    function removeInvoice() {
        ...
        swal({
            ...
            setTimeout(function () {
                $.ajax({
                    url: "/RceInvoice/Delete?id=" + dataItem.id,
                    type: "Get",
...
$(".exportExcel").on('click', function () {
    $("#GridRceInvoice").getKendoGrid().saveAsExcel();
});
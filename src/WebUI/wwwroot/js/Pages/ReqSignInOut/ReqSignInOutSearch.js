$(document).ready(function () {
    ...
    $("#btnSearch").on('click', function () {
        ...
        if (employeeId == "" || employeeId == "0") {
            ...
            var url = '/ReqSignInOut/EmployeeSignInOutList?id=' + employeeId + '&dateFrom=' + dateFrom + '&dateTo=' + dateTo;
    ...
    $("#btnPrint").click(function () {
        ...
        if (employeeId == "" || employeeId == "0") {
            ...
            var url = '/ReqSignInOut/EmployeeSignInOutListPrint?id=' + employeeId + '&dateFrom=' + dateFrom + '&dateTo=' + dateTo;

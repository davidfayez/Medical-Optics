...
$(document).ready(function () {
    ...
    loadInsurancePolicyGrid();

    function loadInsurancePolicyGrid() {
        var dataSource = new kendo.data.DataSource({
            transport: {
                read: {
                    url: "/InsurancePolicy/GetAllInsurancePolicy",
                    Type: "GET"
                }
            },
            error: function (e) {
        ...
        var grid = $("#InsurancePolicyGrid").kendoGrid({
            excel: {
                fileName: "Insurance Policy.xlsx",
                allPages: true,
                filterable: true
            },
            ...
            columns: [
                ...
                { width: Resources.DoubleActionWidth, template: "<a  href='/InsurancePolicy/Edit/#= id #'  class='btn btn-success btn-sm btnEdit'><i class='fas fa-edit'></i></a> <a  class='btn btn-danger btn-sm btnDelete' ><i class='fas fa-trash-alt'></i></a>" },
        ...
        grid.data("kendoGrid").table.on("click", ".btnDelete", removeInsurancePolicy);
    }

    function removeInsurancePolicy() {

        var row = $(this).closest("tr"),
            grid = $("#InsurancePolicyGrid").data("kendoGrid"),
        ...
        swal({
            ...
            setTimeout(function () {
                $.ajax({
                    url: "/InsurancePolicy/Delete?id=" + dataItem.id,
                    type: "Get",
...
$(".exportExcel").on('click', function () {
    $("#InsurancePolicyGrid").getKendoGrid().saveAsExcel();
});

function removeInsurancePolicyEdit(id) {
    ...
    swal({
        ...
        setTimeout(function () {
            $.ajax({
                url: "/InsurancePolicy/Delete?id=" + id,
                type: "Get",
                contentType: 'application/json; charset=utf-8',
                success: function (result) {
                    ...
                    if (result) {
                        swal({
                            ...
                            window.location.href = '/InsurancePolicy/Index'
                        });
                    }
                    else {
                        swal({

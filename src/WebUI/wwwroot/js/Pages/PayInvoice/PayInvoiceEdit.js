$(document).ready(function () {
    ...
    tempSource = new kendo.data.DataSource({
        transport: {
            read: {
                url: "/PayInvoice/GetPayInvoiceDetailsById?id=" + id,
                Type: "GET"
            },
    ...
    function removeBondDetailRow() {
        ...
        var row = $(this).closest("tr"),
            ...
            dataSource = $("#PayInvoiceDetailsgrid").data("kendoGrid").dataSource;
        swal({
            ...
            if (detailId != "" && detailId != null) {
                setTimeout(function () {
                    $.ajax({
                        url: "/PayInvoice/DeleteBondDetail?id=" + detailId,
                        type: "Get",
...
function SubmitPayInvoiceEdit() {
    ...
    if ((isNaN(paySupplier) || paySupplier == "0" || paySupplier == "") && (isNaN(paySubSupplier) || paySubSupplier == "0" || paySubSupplier == "")) {
        ...
        var Obj = {
            ...
            FK_CostCenterId: $("#FK_CostCenterId").val() > 0 ? parseInt($("#FK_CostCenterId").val()) : null,
...
$("#btnPrint").on('click', function () {
    ...
    var url = "/PayInvoice/ReportPrint?id=" + $("#Id").val();

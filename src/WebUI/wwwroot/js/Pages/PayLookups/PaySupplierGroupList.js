$(document).ready(function () {
    ...
    function loadPaySupplierGroupGrid() {
        ...
        var grid = $("#PaySupplierGroupGrid").kendoGrid({
            ...
            columns: [
                ...
                { width: Resources.DoubleActionWidth, template: "<a  href='/PayLookups/EditPaySupplierGroup/#= id #'  class='btn btn-success btn-sm btnEdit'><i class='fas fa-edit'></i></a> <a  class='btn btn-danger btn-sm btnDelete ' ><i class='fas fa-trash-alt'></i></a>" },
    ...
    $("#DefBranches").change(function () {
        ...
        $('#PaySupplierGroupGrid').data('kendoGrid').dataSource.read({ fK_DefBranchId: fK_DefBranchId });
    });
});

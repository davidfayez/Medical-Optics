$(document).ready(function () {
    ...
    function loadPaymentTypeGrid() {
        var dataSource = new kendo.data.DataSource({
            transport: {
                read: {
                    url: "/PayLookups/GetAllPaymentType",
                    Type: "GET"
                }
            },
            error: function (e) {
        ...
        var grid = $("#PaymentTypeGrid").kendoGrid({
            excel: {
                fileName: "Payment Type.xlsx",
            ...
            columns: [
                ...
                },
                {
                    ...
                    template: '#if(standalone==="True") {#<a  href="/PayLookups/EditPaymentType/#= id #?standalone=1"  class="btn btn-success btn-sm btnEdit"><i class="fas fa-edit"></i></a> <a  class="btn btn-danger btn-sm btnDelete" ><i class="fas fa-trash-alt"></i></a>#} else {# <a  href="/PayLookups/EditPaymentType/#= id # "  class="btn btn-success btn-sm btnEdit"><i class="fas fa-edit"></i></a> <a  class="btn btn-danger btn-sm btnDelete" ><i class="fas fa-trash-alt"></i></a> #}#'
                },
        ...
        grid.data("kendoGrid").table.on("click", ".btnDelete", removePaymentType);
    }

    function removePaymentType() {

        var row = $(this).closest("tr"),
            grid = $("#PaymentTypeGrid").data("kendoGrid"),
        ...
        swal({
            ...
            setTimeout(function () {
                $.ajax({
                    url: "/PayLookups/DeletePaymentType?Id=" + dataItem.id,
                    type: "Get",
...
$(".exportExcel").on('click', function () {
    $("#PaymentTypeGrid").getKendoGrid().saveAsExcel();
});
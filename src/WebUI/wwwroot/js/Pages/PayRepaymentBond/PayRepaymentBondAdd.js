$().ready(function () {
    ...
    function loadPayRepaymentDetailsGrid(suppId) {
        ...
        var dataSource = new kendo.data.DataSource({
            ...
            transport: {
                read: {
                    url: "/PayRepaymentBond/GetAllPayReference?supplierId=" + suppId + "&branchId=" + parseInt($("#FK_DefBranchId").val()),
                    Type: "GET"
                }
            },
            error: function (e) {
...
function checkPeriodAndSavePayRepaymentBond() {
...
function SubmitPayRepaymentBondCreate() {

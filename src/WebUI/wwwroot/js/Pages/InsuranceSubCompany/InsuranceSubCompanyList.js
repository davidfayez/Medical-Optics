$(document).ready(function () {
    ...
    LoadGridInsuranceSubCompany();
    function LoadGridInsuranceSubCompany() {
        var grid = $("#GridInsuranceSubCompany").kendoGrid({
            excel: {
                fileName: "Insurance Sub Companies.xlsx",
                allPages: Resources.GridAllPages,
                filterable: Resources.GridFilterable
            },
            dataSource: {
                transport: {
                    read: "/InsuranceSubCompany/GetAll"
                },
                schema: {
                    model: {
                        id: "id",
            ...
            {
                width: Resources.DoubleActionWidth, template: "<a  href='/InsuranceSubCompany/Edit/#= id #'  class='btn btn-success btn-sm btnEdit'><i class='fas fa-edit'></i></a> <a  class='btn btn-danger btn-sm btnDelete' ><i class='fas fa-trash-alt'></i></a>"
            },
    ...
    function removeColor() {
        ...
        var row = $(this).closest("tr"),
            grid = $("#GridInsuranceSubCompany").data("kendoGrid"),
        ...
        swal({
            ...
            setTimeout(function () {
                $.ajax({
                    url: "/InsuranceSubCompany/Delete?id=" + dataItem.id,
                    type: "Get",
...
$(".exportExcel").on('click', function () {
    $("#GridInsuranceSubCompany").getKendoGrid().saveAsExcel();
});
$(document).ready(function () {
    ...
    function loadInsuranceCode() {
        var dataSource = new kendo.data.DataSource({
            transport: {
                read: {
                    url: "/InsuranceCode/GetAll",
                    Type: "GET"
                }
            },
            error: function (e) {
        ...
        var grid = $("#InsuranceCodeGrid").kendoGrid({
            excel: {
                fileName: "Insurance Code.xlsx",
            ...
            columns: [
                ...
                },
                {
                    ...
                    template: "<a  href='/InsuranceCode/Edit/#= id #'  class='btn btn-success btn-sm btnEdit'><i class='fas fa-edit'></i></a> <a  class='btn btn-danger btn-sm btnDelete' ><i class='fas fa-trash-alt'></i></a>"
        ...
        grid.data("kendoGrid").table.on("click", ".btnDelete", removeInsuranceCode);
    }

    function removeInsuranceCode() {

        //var deletee = stringify(resources.delete).serialize();

        var row = $(this).closest("tr"),
            grid = $("#InsuranceCodeGrid").data("kendoGrid"),
        ...
        swal({
            ...
            setTimeout(function () {
                $.ajax({
                    url: "/InsuranceCode/Delete?Id=" + dataItem.id,
                    type: "Get",
...
$(".exportExcel").on('click', function () {
    $("#InsuranceCodeGrid").getKendoGrid().saveAsExcel();
});
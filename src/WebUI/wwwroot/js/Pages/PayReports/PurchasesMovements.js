$(document).ready(function () {
    ...
    var dataSource = new kendo.data.DataSource({
        transport: {
            read: {
                url: "/PayReports/GetPurchasesMovements",
                Type: "GET"
            }
        },
        error: function (e) {
    ...
    $("#GridPurchasesMovements").kendoGrid({
        excel: {
...
$("#btnDataReview").on('click', function () {
    ...
    $('#GridPurchasesMovements').data('kendoGrid').dataSource.read({ suppliersId: suppliersId, invoiceType: invoiceType, serial: serial, dateFrom: dateFrom, dateTo: dateTo, fK_DefBranchId: fK_DefBranchId, supplierCategoryId: supplierCategoryId, supplierGroupId: supplierGroupId, supplierClassId: supplierClassId, supplierTypeId: supplierTypeId });
});

$(".exportExcel").on('click', function () {
    $("#GridPurchasesMovements").getKendoGrid().saveAsExcel();
});
...
$(".btnPrint").on('click', function () {
    ...
    var url = "/PayReports/PurchasesMovementsPrint?suppliersId=" + suppliersId + "&invoiceType=" + invoiceType + "&serial=" + serial + "&dateFrom=" + dateFrom + "&dateTo=" + dateTo + "&fK_DefBranchId=" + fK_DefBranchId + "&supplierCategoryId=" + supplierCategoryId + "&supplierGroupId=" + supplierGroupId + "&supplierClassId=" + supplierClassId + "&supplierTypeId=" + supplierTypeId;

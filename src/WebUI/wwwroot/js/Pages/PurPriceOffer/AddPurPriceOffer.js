$(document).ready(function () {
    ...
    var id = $("#FK_PurchaseOrderId").val();
    var ids = string.split(",").map(String);

    //var y = url.substring(url.lastIndexOf('&'));
    ...
    var tempSource = new kendo.data.DataSource({
        transport: {
            read: {
                url: "/PurchaseOrder/GetPurOfferDetailsByIdAndExceptIds?id=" + id + "&ids=" + ids,
                Type: "GET"
            },
    ...
    $("#btnSaveBalance").click(function () {
        ...
        if (table.length > 0 && $("#SerialNumber").val() > 0 && $("#ExpireAfter").val() > 0) {
                ...
                success: function (result) {
                    if (result > 0) {
                        swal({
                            ...
                            setTimeout(function () {
                                debugger
                                document.location = "../../PurPriceOffer/Edit?id=" + result
                            }, 3000);
                        });
                        //document.location = "../../PurPriceOffer/Edit?id=" + result;
                    } else {

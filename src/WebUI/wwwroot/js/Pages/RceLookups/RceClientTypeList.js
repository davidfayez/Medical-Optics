$(document).ready(function () {
    ...
    $("#DefBranches").change(function () {
        ...
        $('#clientTypeGrid').data('kendoGrid').dataSource.read({ fK_DefBranchId: fK_DefBranchId });
    });
    loadRceClientTypeGrid();

    function loadRceClientTypeGrid() {
        var dataSource = new kendo.data.DataSource({
            transport: {
                read: {
                    url: "/RceLookups/GetAllRceClientType",
                    Type: "GET"
                }
            },
            error: function (e) {
        ...
        var grid = $("#clientTypeGrid").kendoGrid({
            excel: {
                fileName: "Client Types.xlsx",
            ...
            columns: [
                ...
                { width: Resources.DoubleActionWidth, template: "<a  href='/RceLookups/EditRceClientType/#= id #'  class='btn btn-success btn-sm btnEdit'><i class='fas fa-edit'></i></a> <a  class='btn btn-danger btn-sm btnDelete' ><i class='fas fa-trash-alt'></i></a>" },
        ...
        grid.data("kendoGrid").table.on("click", ".btnDelete", removeRceClientType);
    }

    function removeRceClientType() {

        var row = $(this).closest("tr"),
            grid = $("#clientTypeGrid").data("kendoGrid"),
        ...
        swal({
            ...
            setTimeout(function () {
                $.ajax({
                    url: "/RceLookups/DeleteRceClientType?id=" + dataItem.id,
                    type: "Get",
...
$(".exportExcel").on('click', function () {
    $("#clientTypeGrid").getKendoGrid().saveAsExcel();
});
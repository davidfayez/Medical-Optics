$(document).ready(function () {
    $("#DefBranches").change(function () {
        ...
        $('#SalesTypeGrid').data('kendoGrid').dataSource.read({ fK_DefBranchId: fK_DefBranchId });
    });

    loadSalesTypeGrid();

    function loadSalesTypeGrid() {
        var dataSource = new kendo.data.DataSource({
            transport: {
                read: {
                    url: "/RceLookups/GetAllSalesType",
                    Type: "GET"
                }
            },
            error: function (e) {
        ...
        var grid = $("#SalesTypeGrid").kendoGrid({
            excel: {
                fileName: "Sales Type.xlsx",
            ...
            columns: [
                ...
                { width: Resources.DoubleActionWidth, template: "<a  href='/RceLookups/EditSalesType/#= id #'  class='btn btn-success btn-sm btnEdit'><i class='fas fa-edit'></i></a> <a  class='btn btn-danger btn-sm btnDelete ' ><i class='fas fa-trash-alt'></i></a>" },
        ...
        grid.data("kendoGrid").table.on("click", ".btnDelete", removeSalesType);
    }

    function removeSalesType() {

        var row = $(this).closest("tr"),
            grid = $("#SalesTypeGrid").data("kendoGrid"),
        ...
        swal({
            ...
            setTimeout(function () {
                $.ajax({
                    url: "/RceLookups/DeleteSalesType?Id=" + dataItem.id,
                    type: "Get",
...
$(".exportExcel").on('click', function () {
    $("#SalesTypeGrid").getKendoGrid().saveAsExcel();
});
$(document).ready(function () {
                ...
                parameterMap: function (data, action) {
                    ...
                    if (action === "read") {
                        if (Object.keys(data).length > 0) {
                            ...
                            return {
                                id: $("#FK_HrForeignMinistryVisaId").val(),
                            };
                        }
    ...
    tempSource = new kendo.data.DataSource({
        transport: {
            read: {
                url: "/HrEmployeeVisa/GetDetailsById?id=" + $("#Id").val(),
                Type: "GET"
            },
        ...
        schema: {
            model: {
                ...
                fields: {
                    ...
                    fK_HrAgencyTypeId: { editable: false },
                    employeeCode: { type: "text", editable: false },
                    employeeName: { type: "text", editable: false },
                    agencyTypeName: { type: "text", editable: false },
                    description: { type: "text", editable: false },


                    arrivalDate: { type: "date", editable: false },
